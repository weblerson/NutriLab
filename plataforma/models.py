...
class DadosPaciente(models.Model):
    ...
    def __str__(self):
        return f"Paciente: {self.paciente.nome}; Peso: {self.peso}"
...
class Refeicao(models.Model):
    ...
    def __str__(self):
        return f"{self.titulo} para {self.paciente.nome}."
...
class Opcao(models.Model):
    ...
    def __str__(self):
        return f"Opção de refeição de {self.refeicao.titulo} para {self.refeicao.paciente.nome}."